...
import findRoute, {
  getUrlQuery,
} from '/Users/xpy123/Desktop/有赞模板/myself-demo/react-antdPro/node_modules/umi-build-dev/lib/findRoute.js';
...
(() => {
  try {
    ...
    require('../../../node_modules/umi-plugin-ui/lib/bubble').default({
      port: 3000,
      path: '/Users/xpy123/Desktop/有赞模板/myself-demo/react-antdPro',
      currentProject: '',
      isBigfish: undefined,
    });
  } catch (e) {
