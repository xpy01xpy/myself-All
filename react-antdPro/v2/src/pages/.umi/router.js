...
import RendererWrapper0 from '/Users/xpy123/Desktop/有赞模板/myself-demo/react-antdPro/src/pages/.umi/LocaleWrapper.jsx';
  ...
  },
  {
    ...
    component: __IS_BROWSER
      ? _dvaDynamic({
          ...
          LoadingComponent: require('/Users/xpy123/Desktop/有赞模板/myself-demo/react-antdPro/src/components/PageLoading/index')
            .default,
        })
    ...
    routes: [
      {
        ...
        component: __IS_BROWSER
          ? _dvaDynamic({
              ...
              models: () => [
                import('/Users/xpy123/Desktop/有赞模板/myself-demo/react-antdPro/src/pages/User/models/login.js').then(
                  m => {
                    return { namespace: 'login', ...m.default };
                  },
                ),
                import('/Users/xpy123/Desktop/有赞模板/myself-demo/react-antdPro/src/pages/User/models/register.js').then(
                  m => {
      ...
      },
      {
        component: () =>
          React.createElement(
            require('/Users/xpy123/Desktop/有赞模板/myself-demo/react-antdPro/node_modules/umi-build-dev/lib/plugins/404/NotFound.js')
              .default,
        ...
        routes: [
          {
            ...
            component: __IS_BROWSER
              ? _dvaDynamic({
                  app: require('@tmp/dva').getApp(),
                  models: () => [
                    import('/Users/xpy123/Desktop/有赞模板/myself-demo/react-antdPro/src/pages/Dashboard/models/activities.js').then(
                      m => {
                        return { namespace: 'activities', ...m.default };
                      },
                    ),
                    import('/Users/xpy123/Desktop/有赞模板/myself-demo/react-antdPro/src/pages/Dashboard/models/chart.js').then(
                      m => {
                        return { namespace: 'chart', ...m.default };
                      },
                    ),
                    import('/Users/xpy123/Desktop/有赞模板/myself-demo/react-antdPro/src/pages/Dashboard/models/monitor.js').then(
                      m => {
        ...
        routes: [
          {
            ...
            component: __IS_BROWSER
              ? _dvaDynamic({
                  app: require('@tmp/dva').getApp(),
                  models: () => [
                    import('/Users/xpy123/Desktop/有赞模板/myself-demo/react-antdPro/src/pages/Forms/models/form.js').then(
                      m => {
        ...
        routes: [
          {
            ...
            component: __IS_BROWSER
              ? _dvaDynamic({
                  app: require('@tmp/dva').getApp(),
                  models: () => [
                    import('/Users/xpy123/Desktop/有赞模板/myself-demo/react-antdPro/src/pages/List/models/rule.js').then(
                      m => {
        ...
        routes: [
          {
            ...
            component: __IS_BROWSER
              ? _dvaDynamic({
                  app: require('@tmp/dva').getApp(),
                  models: () => [
                    import('/Users/xpy123/Desktop/有赞模板/myself-demo/react-antdPro/src/pages/Profile/models/profile.js').then(
                      m => {
        ...
        routes: [
          {
            ...
            component: __IS_BROWSER
              ? _dvaDynamic({
                  app: require('@tmp/dva').getApp(),
                  models: () => [
                    import('/Users/xpy123/Desktop/有赞模板/myself-demo/react-antdPro/src/pages/Exception/models/error.js').then(
                      m => {
          ...
          },
          {
            ...
            component: __IS_BROWSER
              ? _dvaDynamic({
                  app: require('@tmp/dva').getApp(),
                  models: () => [
                    import('/Users/xpy123/Desktop/有赞模板/myself-demo/react-antdPro/src/pages/Account/Settings/models/geographic.js').then(
                      m => {
